...
var app = (function (Stripe) {
    ...
    var Stripe__namespace = /*#__PURE__*/_interopNamespace(Stripe);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h1, "class", "svelte-9nkstk");
    			add_location(h1, file$2, 10, 1, 252);
    			attr_dev(button, "class", "payment-btn svelte-9nkstk");
    			add_location(button, file$2, 11, 1, 278);
    			attr_dev(main, "class", "svelte-9nkstk");
    			add_location(main, file$2, 9, 0, 243);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*onClickPayment*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let stripe = Stripe__namespace('pk_test_...');
    	...
    	$$self.$capture_state = () => ({ navigate, Stripe: Stripe__namespace, stripe, onClickPayment });
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			claim_component(payment.$$.fragment, nodes);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:3) <Route path=\\\"/success\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:1) <Router basepath=\\\"/\\\" url=\\\"{url}\\\">",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(main, file, 7, 0, 199);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, main, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Payment, Success, url });
